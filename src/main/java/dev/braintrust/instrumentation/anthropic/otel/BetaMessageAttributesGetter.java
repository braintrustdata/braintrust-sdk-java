...
enum BetaMessageAttributesGetter
        implements GenAiAttributesGetter<MessageCreateParams, BetaMessage> {
    INSTANCE;
    ...
    public List<String> getResponseFinishReasons(
            MessageCreateParams request, @Nullable BetaMessage response) {
        if (response == null) {
            return emptyList();
        }
    ...
    @Override
    @Nullable
    public String getResponseId(MessageCreateParams request, @Nullable BetaMessage response) {
        if (response == null) {
            return null;
        }
        return response.id();
    ...
    @Override
    @Nullable
    public String getResponseModel(MessageCreateParams request, @Nullable BetaMessage response) {
        if (response == null) {
            return null;
        }
    ...
    @Override
    @Nullable
    public Long getUsageInputTokens(MessageCreateParams request, @Nullable BetaMessage response) {
        if (response == null) {
            return null;
        }
    ...
    @Override
    @Nullable
    public Long getUsageOutputTokens(MessageCreateParams request, @Nullable BetaMessage response) {
        if (response == null) {
            return null;
        }
