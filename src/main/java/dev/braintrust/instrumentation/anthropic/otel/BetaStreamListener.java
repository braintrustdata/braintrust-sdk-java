...
final class BetaStreamListener {
    ...
    @Nullable private BetaUsage usage;
    @Nullable private BetaMessageDeltaUsage deltaUsage;
    ...
    @SneakyThrows
    void onEvent(BetaRawMessageStreamEvent event) {
    ...
    void endSpan(@Nullable Throwable error) {
        ...
        // Set response attributes directly on the span since building a valid BetaMessage is
        // complex. The content was already written to braintrust.output_json in onEvent.
