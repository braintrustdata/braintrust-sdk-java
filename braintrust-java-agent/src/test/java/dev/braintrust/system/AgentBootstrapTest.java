            ...
            agentJar.stream()
                    .forEach(
                            entry -> {
                                ...
                                if (resourceName.startsWith("dev/braintrust/system/DDBridge")
                                        || resourceName.startsWith("dev/braintrust/agent/dd/")) {
                                    // TODO: figure out DD Bridge strategy
                                    return;
                                }
                                ...
                                if (resourceName.endsWith(".class")) {
                                    ...
                                    var className = toClassName(resourceName);
                                    try {
                                        // TODO: this seems funky. why are we bundling classes _and_
                                        // putting them on the bootstrap?
                                        ...
                                        if (className.startsWith("dev.braintrust")
                                            ...
                                            System.out.println(
                                                    "ignoring internal class load failure: "
                                                            + className);
                                        }
                                    }
                                }
