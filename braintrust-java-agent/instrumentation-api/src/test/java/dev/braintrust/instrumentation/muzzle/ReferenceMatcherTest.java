...
class ReferenceMatcherTest {
    ...
    void matchesClassThatExists() {
        Reference ref =
                new Reference.Builder("java/util/ArrayList")
                        .withSource("Test", 1)
    ...
    void failsForMissingClass() {
        Reference ref =
                new Reference.Builder("com/example/NoSuchClass").withSource("Test", 1).build();
    ...
    void matchesFieldThatExists() {
        ...
        Reference ref =
                new Reference.Builder("java/lang/System")
                        .withSource("Test", 1)
                        .withFlag(Reference.EXPECTS_PUBLIC)
                        .withField(
                                new String[] {"Test:1"},
    ...
    void failsForWrongClassFlags() {
        // Create a reference that expects public + interface on ArrayList (which is not an
        // interface)
        Reference ref =
                new Reference.Builder("java/util/ArrayList")
                        .withSource("Test", 1)
    ...
    void matchesInterfaceFlag() {
        Reference ref =
                new Reference.Builder("java/util/List")
                        .withSource("Test", 1)
    ...
    void findsMethodInSuperclass() {
        ...
        ReferenceMatcher matcher = new ReferenceMatcher(ref);
        assertTrue(
                matcher.matches(getClass().getClassLoader()),
    ...
    void reportsAllMismatches() {
        ...
        Reference bad1 =
                new Reference.Builder("com/example/Missing1").withSource("Test", 2).build();

        Reference bad2 =
                new Reference.Builder("com/example/Missing2").withSource("Test", 3).build();
    ...
    void failsForWrongMethodFlags() {
        ...
        boolean foundFlagMismatch =
                mismatches.stream().anyMatch(m -> m instanceof Reference.Mismatch.MissingFlag);
