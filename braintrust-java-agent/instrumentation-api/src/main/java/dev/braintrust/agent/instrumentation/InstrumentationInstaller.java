...
public class InstrumentationInstaller {
    ...
    public static void install(Instrumentation inst, ClassLoader agentClassloader) {
        var agentBuilder =
                new AgentBuilder.Default()
                        ...
                        // (e.g. GlobalOpenTelemetry which is loaded before instrumentation installs)
                        ...
                        // is null and can't find types like OTel API (which live on the app classpath).
    ...
    /**
     * A pool strategy that falls back to the agent classloader for type resolution.
     * This is needed for transforming bootstrap classes, where the target classloader is null
     * and the default pool strategy can't find types like {@code OpenTelemetry}.
     */
    private static class BootstrapFallbackPoolStrategy implements AgentBuilder.PoolStrategy {
        ...
        public TypePool typePool(ClassFileLocator classFileLocator, ClassLoader classLoader) {
            ...
            ClassFileLocator compound = new ClassFileLocator.Compound(classFileLocator, fallbackLocator);
