 ...
 * </pre>
 *
 * which constructs a {@link ReferenceMatcher} containing all the {@link Reference}s extracted from
 * the module's advice bytecode by {@link ReferenceCreator}. This eliminates the need to run ASM
 * scanning at agent startup.
 *
