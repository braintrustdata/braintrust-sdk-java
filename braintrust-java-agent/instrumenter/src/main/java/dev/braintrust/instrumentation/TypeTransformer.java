...
public interface TypeTransformer {
     ...
     *
     * <p>The advice class should be a class with static methods annotated with {@link
     * net.bytebuddy.asm.Advice.OnMethodEnter} and/or {@link net.bytebuddy.asm.Advice.OnMethodExit}.
     *
