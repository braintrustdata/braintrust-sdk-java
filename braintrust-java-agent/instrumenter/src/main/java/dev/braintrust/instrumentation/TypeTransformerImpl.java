...
/**
 * Implementation of {@link TypeTransformer} that translates {@link #applyAdviceToMethod} calls into
 * ByteBuddy {@link Advice} visitors on a {@link DynamicType.Builder}.
 */
class TypeTransformerImpl implements TypeTransformer {
    ...
    private Class<?> loadAdviceClass(String adviceClassName) {
        try {
            ...
            throw new IllegalArgumentException("Advice class not found: " + adviceClassName, e);
        }
    }
}
