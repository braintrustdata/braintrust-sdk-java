...
import dev.braintrust.instrumentation.AdviceCollector;
...
public class MuzzleGenerator {
    ...
    private static final String REFERENCE_MATCHER_INTERNAL =
    ...
    public static void generate(
            InstrumentationModule module, File targetDir, ClassLoader classLoader) {
    ...
    /**
     * Collect all references from the module's advice bytecode, filtering out helper classes and
     * module-specific ignored classes.
     */
            ...
            for (String adviceClass : collector.getAdviceClasses()) {
                for (Map.Entry<String, Reference> entry :
                        ReferenceCreator.createReferencesFrom(
                                        adviceClass, classLoader, helperClasses)
                                .entrySet()) {
