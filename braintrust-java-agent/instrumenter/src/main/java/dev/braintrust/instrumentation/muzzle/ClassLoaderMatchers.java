...
/**
 * Utility methods for creating classloader matchers that check for the presence of classes without
 * actually loading them (using resource lookups instead).
 */
public final class ClassLoaderMatchers {
    ...
    /**
     * Returns a matcher that checks if the given class exists on the classloader's classpath by
     * looking up the .class file as a resource. This does NOT trigger class loading, linking, or
