...
public class Reference {
    ...
    public static boolean matches(int flags, int modifiers) {
        if ((flags & EXPECTS_PUBLIC) != 0 && (modifiers & Opcodes.ACC_PUBLIC) == 0) {
            ...
            return false;
        } else if ((flags & EXPECTS_NON_INTERFACE) != 0
                && (modifiers & Opcodes.ACC_INTERFACE) != 0) {
            return false;
    ...
    public abstract static class Mismatch {
        ...
        public static class MissingField extends Mismatch {
            ...
            public MissingField(
                    String[] sources, String className, String fieldName, String fieldDesc) {
                super(sources);
                this.className = className;
        ...
        public static class MissingMethod extends Mismatch {
            ...
            public MissingMethod(
                    String[] sources, String className, String method, String methodType) {
                super(sources);
                this.className = className;
                this.method = method;
                this.methodType = methodType;
        ...
        public static class ReferenceCheckError extends Mismatch {
            ...
            public ReferenceCheckError(
                    Exception referenceCheckException,
                    Reference referenceBeingChecked,
                    String location) {
                super(new String[0]);
    ...
    public static class Builder {
        ...
        public Builder withMethod(
            ...
            return withMethod(
                    sources, methodFlags, methodName, returnType.getDescriptor(), paramDescs);
        }
    ...
    static <E> E[] mergeArrays(E[] array1, E[] array2) {
        ...
        return set.toArray(
                (E[]) Array.newInstance(array1.getClass().getComponentType(), set.size()));
    }
