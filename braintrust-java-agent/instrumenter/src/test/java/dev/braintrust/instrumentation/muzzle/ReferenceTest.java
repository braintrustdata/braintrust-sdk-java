...
class ReferenceTest {
    ...
    void mergeSameMethodCombinesFlags() {
        ...
        assertEquals(1, merged.methods.length);
        assertEquals(
                Reference.EXPECTS_PUBLIC | Reference.EXPECTS_NON_STATIC, merged.methods[0].flags);
    }
