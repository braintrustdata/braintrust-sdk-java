...
/**
 * Test advice that references FakeLibraryClass in various ways so that ReferenceCreator can extract
 * those references. This exercises:
 *
 * <ul>
 *   <li>Instance method call (invokevirtual) — doWork(String)
 *   <li>Static field access (getstatic) — VERSION
 *   <li>Return type extraction — createResult() returns FakeResult
 *   <li>BFS transitive discovery — calls FakeHelper.record() which calls FakeLibraryClass.parse()
 * </ul>
 */
