...
/** Spring Boot application demonstrating Braintrust + Spring AI 2.x integration */
...
public class SpringAI2Example {

    public static void main(String[] args) {
        var app = new SpringApplication(SpringAI2Example.class);
    ...
    public CommandLineRunner run(List<ChatModel> chatModels, Tracer tracer, Braintrust braintrust) {
        return args -> {
            Span rootSpan = tracer.spanBuilder("spring-ai2-example").startSpan();
    ...
    public List<ChatModel> chatModels(OpenTelemetry openTelemetry) {
        ...
        // Spring AI 2.x builds the official-SDK client internally from the connection details on
        // the chat options, so BraintrustSpringAI.wrap instruments the already-built model in
        // place (unlike 1.x, which wraps the builder).
                    ...
                    OpenAiChatModel.builder()
                            .options(
                                    OpenAiChatOptions.builder()
                                            ...
                                            .build())
                            .build();
            models.add(BraintrustSpringAI.wrap(openTelemetry, model));
        }
        ...
        // BraintrustSpringAI: the wrapped client is injected into the Spring AI model builder.
        // This is identical to the springai1 example — the mechanism does not depend on the
        // spring-ai version.
